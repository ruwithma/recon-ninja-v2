...
TOOL_REGISTRY: list[ToolInfo] = [
    ...
    ToolInfo(
        ...
        version_flag="--version",
        description="Command-line URL transfer tool (used by web modules)",
    ),
    ToolInfo(
        name="dig",
        category="required",
        ...
        version_flag="--version",
        description="DNS lookup utility (used by DNS module)",
    ),
    ToolInfo(
        name="whois",
        category="optional",
        ...
        version_flag="--version",
        description="Domain registration lookup (used by OSINT module)",
    ),
    ToolInfo(
        name="showmount",
        category="optional",
        ...
        version_flag="--help",
        description="NFS export lister (used by NFS module)",
    ),
    ToolInfo(
        name="redis-cli",
        category="optional",
        ...
        version_flag="--version",
        description="Redis command-line client (used by database module)",
    ),
    ToolInfo(
        name="rpcclient",
        category="optional",
        ...
        version_flag="--version",
        description="SMB/RPC client (used by RPC module)",
    ),
    ToolInfo(
        name="rpcinfo",
        category="optional",
        ...
        version_flag="--version",
        description="RPC portmapper info (used by RPC module)",
    ),
    ToolInfo(
        name="smtp-user-enum",
        category="optional",
        install_method="apt",
        install_package="smtp-user-enum",
        version_flag="--version",
    ...
    ToolInfo(
        ...
        alt_names=["xfreerdp3"],
        version_flag="--version",
        description="FreeRDP X11 client (used by RDP module)",
    ),
    ToolInfo(
        name="evil-winrm",
        category="optional",
        install_method="gem",
        install_package="evil-winrm",
        version_flag="--version",
        description="WinRM shell (used by WinRM module)",
    ),
    ToolInfo(
        name="impacket-rpcdump",
        category="optional",
        install_method="pip",
        install_package="impacket",
        alt_names=["rpcdump.py"],
        version_flag="--version",
        description="Impacket RPC endpoint mapper (used by RPC module)",
    ),
    ToolInfo(
        name="shodan",
        category="optional",
        ...
        version_flag="--version",
        description="Shodan CLI (used by OSINT module)",
    ),
    ToolInfo(
        name="wafw00f",
        category="optional",
        ...
        version_flag="--version",
        description="Web application firewall detector (used by web_core module)",
    ),
    ToolInfo(
        name="dnsenum",
        category="optional",
        ...
        version_flag="--version",
        description="DNS enumeration tool (used by DNS module)",
    ),
    ToolInfo(
        name="tnscmd10g",
        category="optional",
        ...
        version_flag="--help",
        description="Oracle TNS command tool (used by database module)",
    ),
]
